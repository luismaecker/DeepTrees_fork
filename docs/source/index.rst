...
Welcome to the TorchTrees documentation! 
...
TorchTrees is a PyTorch-based library for end-to-end tree crown segmentation and analysis in multispectral remote sensing imagery. 
...
TorchTrees is a result of the `DeepTrees <https://deeptrees.de>`_ project, a collaboration between the Helmholtz Center for Environmental Research -- UFZ and the Helmholtz AI initiative.
